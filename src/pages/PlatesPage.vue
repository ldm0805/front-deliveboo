...
<template lang="">
    <div class="wrapper">
        ...
        <p class="head-text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna.</p>
            <div class="cards">
                <div v-for="plate in this.plateSlug" :key="plate.id">
                    <div class="card" :class="plate.visible != null ? `text-success` : 'text-danger'" alt="">
