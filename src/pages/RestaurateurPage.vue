                ...
                <nav>
                    <ul class="d-flex list-unstyled gap-2">
                        <li :class="this.store.currentPage === 1 ? 'disabled' : 'page-item'">
                            <button class="page-link" @click="getRestaurateurs(this.store.currentPage - 1)"><i class="fa-solid fa-angle-left"></i> Prev</button>
                        </li>
                        ...
                        <li :class="this.store.currentPage === this.store.lastPage ? 'disabled' : 'page-item'">
                            <button class="page-link" @click="getRestaurateurs(this.store.currentPage + 1)">Next <i class="fa-solid fa-angle-right"></i></button>
                        </li>
                    </ul>
                </nav>
            </div>
                ...
                <nav>
                    <ul class="d-flex list-unstyled gap-2">
                        <li :class="this.currentPage === 1 ? 'disabled' : 'page-item'">
                            <button class="page-link" @click="getRestaurateurs(this.currentPage - 1)"><i class="fa-solid fa-angle-left"></i> Prev</button>
                        </li>
                        ...
                        <li :class="this.currentPage === this.lastPage ? 'disabled' : 'page-item'">
                            <button class="page-link" @click="getRestaurateurs(this.currentPage + 1)">Next <i class="fa-solid fa-angle-right"></i></button>
                        </li>
                    </ul>
                </nav>
            </div>
